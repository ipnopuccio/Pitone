...
class CSVFile:
    ...
    def get_data(self): 
        ...
        if not self.can_read:
            ...
            # Esco dalla funzione returnando "none".
            return None
            ...
            # Apro il file per operare nel file
            my_file = open(self.name, 'r')
...
class NumericalCSVFile(CSVFile):
    ...
    def get_data(self):
        ...
        #super chiama nella classe genitore nella variabile string_data
        ...
        for string_row in string_data:
            ...
            for i,element in enumerate(string_row):
                ...
                if i == 0:
                    # Il primo elemento della riga lo lascio in formato stringa, è la data
                    ...
                    try:
                        ...
                        #rompo il for per andare avanti 
                        break
